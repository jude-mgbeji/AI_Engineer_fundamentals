...
long_Chain = job_tools_prompt_template | chat | ouput_parser | {"tools": RunnablePassthrough()} | learning_startegy_prompt_template | chat | ouput_parser

# which will visually show the relationships between all component runnables within the chain
print(long_Chain.get_graph().print_ascii())
# response = long_Chain.invoke({"job_tittle": "data engineer"})
