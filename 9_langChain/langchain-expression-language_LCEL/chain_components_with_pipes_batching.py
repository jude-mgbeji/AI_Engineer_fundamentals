...
# When we use the batch function on a chain, usually, we want to execute multiple 
# inputs interactions concurrently. We call the batch function of a chain passing 
# a list of dictionaries conatining the template variables
output = chain.batch([{"pet":"dog", "breed": "shepherd"},
